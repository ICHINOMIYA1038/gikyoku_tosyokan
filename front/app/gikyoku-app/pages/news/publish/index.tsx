  ...
  return (
    <NewsLayout>
      <div>
        ...
        <div>
          <p>
            「戯曲図書館」は2019年に劇団かたかごがホームページの一部として制作して以来、たくさんの方にご利用していただいておりましたが、劇団の活動休止により一時更新を停止しておりました。
          </p>
          <br />
          <p>
            劇団としての活動は当面考えてはいないものの、サイトのリニューアルを機にこの「戯曲図書館」だけを切り離して再び運営を開始していきます。
          </p>
          <p>
          ...
          <p>
            でも、まあこじつけで意義を考えてみると私は
            <span className="font-bold">
              「戯曲が無料で読めること自体には反対なのです。」
            </span>
          </p>
          <p>
            一つの戯曲を制作するのに、劇作家は
            <span className="font-bold">多大な経験 と時間</span>を要します。
          </p>
          ...
          <p>
            しかし、なるべく多くの情報を集め、多くの出会いを作る場所にできればなと思っています。
          </p>
          <p>
            活動に同意してくださる方がいればぜひ賛同ボタンをおしていただけると・・・(何も起こりませんが...（笑）)
          </p>

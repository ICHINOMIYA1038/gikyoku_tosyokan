  ...
  return (
    <SupportLayout now="tos">
      <div className="support-document">
        <h2>利用規約</h2>
        <p>
          この利用規約（以下，「本規約」といいます。）戯曲図書館運営者，（以下，「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h3>第1条（適用）</h3>
        <p>
        ...
        <h3>第2条（利用料金）</h3>
        <p>
          本サービスの利用料は無料です。ただし、本サービス上に掲載されている戯曲は全てその戯曲の作者に帰属し、戯曲の利用料はその著作者が決めます。
        </p>
